...
public class ZkClient implements Watcher{
    ...
    //zookeeper服务器地址
    private static final String ZOOKEEPER_ADDRESS = "39.106.30.172:2181,39.106.30.172:2182," +
    ...
    public static void main(String[] args) {
        String parentPath= "/father"; //父节点
        String childrenPath = "/father/children"; //子节点
        ...
        if (isSuccess) {
            ...
            // 创建子节点
            isSuccess = test.createNode(childrenPath, String.valueOf(System.currentTimeMillis()), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
            if(isSuccess){
